    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <Button
            onClick={() => router.push('/instructor/books')}
            variant="ghost"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
            Quay lại danh sách
          ...
          <div className="flex gap-2">
            <Button
              onClick={() => router.push(`/instructor/books/${book.id}/edit`)}
              variant="outline"
            >
                    ...
                    <TabsContent value="chapters" className="mt-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <Button 
                          ...
                          onClick={() => router.push(`/instructor/books/${book.id}/chapters/create`)}
                        >
                        ...
                        <div className="space-y-3">
                          {chapters.map((chapter, index) => (
                            <div
                              ...
                              onClick={() => router.push(`/instructor/books/${book.id}/chapters/${chapter.id}`)}
                            >
                      ...
                      {questions.length === 0 ? (
                        <div className="text-center py-12 text-gray-500">
                          ...
                          <Button 
                            variant="outline" 
                            className="mt-4"
                            onClick={() => router.push(`/instructor/books/${book.id}/questions/create`)}
                          >
                            <Plus className="w-4 h-4 mr-2" />
                            Thêm câu hỏi
                          </Button>
                            ...
                            <div
                              ...
                              onClick={() => {
                                ...
                                if (question.chapterId) {
                                  router.push(`/instructor/books/${book.id}/chapters/${question.chapterId}`);
                                } else {
                                  router.push(`/instructor/books/${book.id}/questions/${question.id}`);
                                }
                              }}
                            >
                              <div className="flex items-start gap-3">
              ...
              <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-md sticky top-6">
                ...
                <CardContent className="space-y-2">
                  <Button 
                    ...
                    onClick={() => router.push(`/instructor/books/${book.id}/activation-codes`)}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full justify-start"
                    onClick={() => router.push(`/instructor/books/${book.id}/questions`)}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full justify-start"
                    onClick={() => router.push(`/instructor/books/${book.id}/analytics`)}
                  >
