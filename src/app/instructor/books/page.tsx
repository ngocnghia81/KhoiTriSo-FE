...
export default function BooksManagementPage() {
  ...
  // Debug logging
  useEffect(() => {
    console.log('instructor Books - Data:', {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-6 relative overflow-hidden">
      ...
      >
        <div className="flex items-center justify-between mb-6">
          ...
          <Button
            onClick={() => router.push('/instructor/books/create')}
                          ...
                          <TableCell className="text-right">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem onClick={() => router.push(`/instructor/books/${book.id}`)}>
                                ...
                                <DropdownMenuItem onClick={() => router.push(`/instructor/books/${book.id}/activation-codes`)}>
