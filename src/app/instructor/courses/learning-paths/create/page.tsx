...
export default function CreateLearningPathPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/instructor/courses/learning-paths');
    } catch (err) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Tạo lộ trình học để admin duyệt và xuất bản
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            <strong>Lưu ý:</strong> Lộ trình học của bạn sẽ được gửi cho admin để duyệt. Sau khi được duyệt, lộ trình sẽ được xuất bản và hiển thị cho học viên.
          </p>
        </div>
