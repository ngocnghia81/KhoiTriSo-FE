    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-3">
          <button
            onClick={() => router.push(`/instructor/courses/${id}/analytics`)}
                ...
                {lessons.map((lesson: any, index: number) => (
                  <div key={lesson.id || lesson.Id || index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0">
                      ...
                      <button
                        onClick={() => router.push(`/instructor/courses/${id}/lessons/${lesson.id || lesson.Id}`)}
                        className="inline-flex items-center px-2 py-1 text-xs text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded"
                        title="Xem bài học"
                      >
                        <EyeIcon className="h-4 w-4" />
                      </button>
                      <button
                        onClick={() => router.push(`/instructor/courses/${id}/lessons/${lesson.id || lesson.Id}/edit`)}
                        className="inline-flex items-center px-2 py-1 text-xs text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded"
                        title="Chỉnh sửa"
                      >
