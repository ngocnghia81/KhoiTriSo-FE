  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && (result.success || result.Success)) {
        ...
        router.push(`/dashboard/books/${bookId}/questions/${questionId}`);
      } else {
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-md">
            <CardContent className="p-12 text-center">
              ...
              <Button onClick={() => router.push(`/dashboard/books/questions`)}>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-6">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <Button
            onClick={() => router.push(`/dashboard/books/${bookId}/questions/${questionId}`)}
            variant="ghost"
            className="mb-4"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
