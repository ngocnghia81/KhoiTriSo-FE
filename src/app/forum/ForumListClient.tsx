...
export default function ForumListClient({ 
  ...
  const [stats, setStats] = useState<ForumStats | null>(initialStats || null);
  ...
  // Use initial data if in default state and available
  const shouldUseInitial = isDefaultState && initialQuestions && initialQuestions.length > 0;
  ...
  // Load categories, tags, stats once (they don't change often)
  useEffect(() => {
